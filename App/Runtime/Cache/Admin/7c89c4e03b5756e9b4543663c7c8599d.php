...
<link rel="stylesheet" href="/Thinkphp_init/Public/css/admin/login.css" />

<div class="container">

	<form class="form-signin" action="/Thinkphp_init/index.php/Admin/Public/check_login" method="post">
		<h2 class="form-signin-heading">
			<img src="/Thinkphp_init/Public/images/admin/logo.png" alt="logo" />
		</h2>
		...
		<div class="form-group verify">
			<img src="/Thinkphp_init/index.php/Admin/Public/verify" alt="Verify" />
...
$("#js_verify").click(function(){
	var url = '/Thinkphp_init/index.php/Admin/Public/verify';
...
$(".form-signin").submit(function(e){
	...
	$.post(url, data , function(json){
		if (json.info == 'ok') {
			lump_ok(json.data);
			window.location.href = "/Thinkphp_init/index.php/Admin/Index/index";
